...
type PlaceRecommendationCardProps = {
  href: string;
};

export function PlaceRecommendationCard({ href }: PlaceRecommendationCardProps) {
  return (
    <Link
      href={href}
      className="flex items-center gap-ds-12 rounded-ds-md bg-surface-secondary p-ds-16 active:bg-surface-tertiary"
    >
